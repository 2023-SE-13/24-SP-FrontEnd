  ...
  <div class="home-page">
    ...
    <div class="post-container">
      <div class="recommend_position">
        <span>精选职位</span>
        <PostPositionUnit v-for="(position,index) in RecommendPositionList" :key="index" :post-data="position"></PostPositionUnit>
      </div>
      <div class="recommend_subscribe">
        <span>推荐企业</span>
        <PostCompanyUnit v-for="(company,index) in RecommendSubscribeList.companies" :key="index" :post-data="company"></PostCompanyUnit>
      </div>
      <div class="recommend_user">
        <span>推荐用户</span>
        <PostUserUnit v-for="(user,index) in RecommendSubscribeList.users" :key="index" :post-data="user"></PostUserUnit>
      </div>
    </div>
  </div>
</template>
<script>
import { getRecommendSubscribe, getRecommendPosition } from "@/api/api";
...
export default {
  ...
  components: { PostPositionUnit, PostCompanyUnit, PostUserUnit },
  methods: {
    allow() {
